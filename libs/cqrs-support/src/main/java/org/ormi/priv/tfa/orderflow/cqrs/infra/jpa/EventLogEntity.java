...
/**
 * JPA entity representing an event in the event log.
 * <p>
 * Stores domain events with their aggregate information, event type,
 * version, timestamp, and JSON payload. Used for event sourcing and
 * maintaining an immutable audit trail of all changes.
 * </p>
 * 
