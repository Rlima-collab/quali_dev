...
/**
 * JPA entity representing an outbox entry for reliable event publishing.
 * <p>
 * Implements the Transactional Outbox pattern to ensure reliable event
 * delivery. Events are first persisted in the outbox table within the
 * same transaction as the domain changes, then asynchronously published.
 * </p>
 * 
