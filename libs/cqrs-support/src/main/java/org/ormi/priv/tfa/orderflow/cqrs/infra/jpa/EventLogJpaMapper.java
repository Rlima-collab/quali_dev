...
/**
 * MapStruct mapper for converting EventEnvelope to EventLogEntity.
 * <p>
 * Handles the transformation of domain events with their metadata
 * into JPA entities for persistence in the event log.
 * </p>
 * 
