...
/**
 * JPA implementation of the EventLogRepository.
 * <p>
 * Persists domain events to the event_log table using Panache.
 * Provides append-only storage for event sourcing.
 * </p>
 * 
