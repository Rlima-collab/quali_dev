...
/**
 * Type-safe envelope wrappers for ProductEventV1 events.
 * <p>
 * Provides concrete envelope types for each product event type,
 * ensuring type safety when handling events in projections and handlers.
 * </p>
 * 
 * @param <E> the specific ProductEventV1 subtype
