...
/**
 * Sealed interface representing version 1 of Product domain events.
 * <p>
 * This interface defines all events that can occur in the Product aggregate lifecycle:
 * <ul>
 *   <li>{@link ProductRegistered} - When a new product is created</li>
 *   <li>{@link ProductRetired} - When a product is retired</li>
 *   <li>{@link ProductNameUpdated} - When a product's name is changed</li>
 *   <li>{@link ProductDescriptionUpdated} - When a product's description is changed</li>
 * </ul>
 * </p>
 * 
