...
/**
 * Read model (projection) representing a complete view of a Product.
 * <p>
 * Contains all product information including metadata, catalog references,
 * and event history. Used for read operations in the CQRS pattern.
 * </p>
 * 
