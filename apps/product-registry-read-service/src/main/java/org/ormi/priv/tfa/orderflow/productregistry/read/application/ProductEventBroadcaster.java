...
/**
 * Broadcaster for product event streaming via SSE.
 * <p>
 * Manages emitters for Server-Sent Events connections and broadcasts
 * product change events to all connected clients in real-time.
 * </p>
 * 
