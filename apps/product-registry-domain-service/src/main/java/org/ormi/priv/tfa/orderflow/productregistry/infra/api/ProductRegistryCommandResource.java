...
/**
 * REST resource for product registry command operations (write side).
 * <p>
 * Exposes HTTP endpoints for:
 * <ul>
 *   <li>POST /products - Register a new product</li>
 *   <li>DELETE /products/{id} - Retire a product</li>
 *   <li>PATCH /products/{id}/name - Update product name</li>
 *   <li>PATCH /products/{id}/description - Update product description</li>
 * </ul>
 * </p>
 * 
