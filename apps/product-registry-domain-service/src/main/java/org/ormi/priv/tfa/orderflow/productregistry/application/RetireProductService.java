...
/**
 * Application service for retiring products.
 * <p>
 * Handles the RetireProductCommand by changing the product status to RETIRED,
 * persisting the change, logging the event, and publishing to the outbox.
 * </p>
 * 
